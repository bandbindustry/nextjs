...
const topServices = [
  {
    ...
    subtitle: "for B & B Self-Developed 3 Core Components",
    href: "#",
  },
  {
    icon: FiTool,
    title: "Pro Installation Guide",
    subtitle: "Step-by-step machine installation walkthrough",
    href: "#",
  },
];

export default function ServiceTopServices() {
