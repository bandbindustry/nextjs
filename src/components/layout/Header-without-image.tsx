...
export default function HeaderWOImage() {
                  ...
                  <div className="w-60 shrink-0">
                    ...
                    <ul className="space-y-0.5">
                      {categories.map((cat) => (
                        <li key={cat.id}>
                          <button
                            className="w-full text-left px-3 py-2 rounded-sm flex items-center justify-between transition-all duration-150 cursor-pointer"
                            style={{
                              background:
                              ...
                              {categoryProducts.slice(0, 10).map((product) => (
                                ...
                                >
                                  <Link
                                    ...
                                    className="flex items-center gap-1.5 py-1 text-sm font-display transition-colors hover:text-[var(--color-accent)]"
                                    style={{ color: "#444" }}
                                  >
                                    <RiArrowRightSLine
                                      size={13}
